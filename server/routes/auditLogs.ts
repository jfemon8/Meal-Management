 ...
 * @access  Admin+
 */
router.get('/categories', protect, isAdmin, async (req: AuthRequest, res: Response) => {
    try {
 ...
 * @access  Admin+
 */
router.get('/actions', protect, isAdmin, async (req: AuthRequest, res: Response) => {
    try {
 ...
 * @access  Admin+
 */
router.get('/summary', protect, isAdmin, async (req: AuthRequest, res: Response) => {
    try {
        const { days = 7 } = req.query;

        const summary = await (AuditLog as any).getActivitySummary({ days: parseInt(days as string) });
 ...
 * @access  SuperAdmin
 */
router.get('/critical', protect, isSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
        const { limit = 20 } = req.query;

        const logs = await (AuditLog as any).getRecentCritical(parseInt(limit as string));
 ...
 * @access  Admin+
 */
router.get('/search', protect, isAdmin, async (req: AuthRequest, res: Response) => {
    try {
        ...
        const result = await (AuditLog as any).search(q, {
            page: parseInt(page as string),
            limit: parseInt(limit as string)
        });
 ...
 * @access  Admin+
 */
router.get('/user/:userId', protect, isAdmin, async (req: AuthRequest, res: Response) => {
    try {
        const { page = 1, limit = 50, category, action } = req.query;

        const result = await (AuditLog as any).getByUser(req.params.userId, {
            page: parseInt(page as string),
            limit: parseInt(limit as string),
            category,
            action
 ...
 * @access  Admin+
 */
router.get('/:id', protect, isAdmin, async (req: AuthRequest, res: Response) => {
    try {
 ...
 * @access  Protected
 */
router.get('/my/history', protect, async (req: AuthRequest, res: Response) => {
    try {
        const { page = 1, limit = 20 } = req.query;

        const result = await (AuditLog as any).getByUser(req.user!._id, {
            page: parseInt(page as string),
            limit: parseInt(limit as string)
        });
 ...
 * @access  SuperAdmin
 */
router.post('/:id/undo', protect, isSuperAdmin, async (req: AuthRequest, res: Response) => {
    try {
        const log: any = await AuditLog.findById(req.params.id);
 ...
 * @access  Admin+
 */
router.get('/managers/list', protect, isAdmin, async (req: AuthRequest, res: Response) => {
    try {
 ...
 * @access  Admin+
 */
router.get('/managers/activity', protect, isAdmin, async (req: AuthRequest, res: Response) => {
    try {
        const {
            page = 1,
            limit = 50,
 ...
 * @access  Admin+
 */
router.get('/managers/summary', protect, isAdmin, async (req: AuthRequest, res: Response) => {
    try {
        ...
        const managersWithStats = activityByManager.map((manager: any) => {
            const categoryCounts: any = {};
            manager.categories.forEach((cat: string) => {
 ...
 * @access  Admin+
 */
router.get('/managers/:managerId/activity', protect, isAdmin, async (req: AuthRequest, res: Response) => {
    try {
        ...
        const query: any = { user: req.params.managerId };
