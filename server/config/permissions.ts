 ...
 * @returns boolean
 */
const hasAnyPermission = (role: string, permissions: string[]): boolean => {
 ...
 * @returns boolean
 */
const hasAllPermissions = (role: string, permissions: string[]): boolean => {
    if (!role || !Array.isArray(permissions)) return false;
 ...
 * @param userPermissions - Custom permissions from user document
 * @param permission - Permission to check
 * @returns boolean
 */
const hasCustomPermission = (userPermissions: string[], permission: string): boolean => {
