 ...
 */
auditLogSchema.statics.log = async function(data: Record<string, any>) {
    try {
 ...
 * Get logs by user
 */
auditLogSchema.statics.getByUser = async function(userId: mongoose.Types.ObjectId | string, options: QueryOptions = {}) {
 ...
 */
auditLogSchema.statics.getByCategory = async function(category: string, options: QueryOptions = {}) {
 ...
 */
auditLogSchema.statics.getActivitySummary = async function(options: { days?: number } = {}) {
 ...
 */
auditLogSchema.statics.getRecentCritical = async function(limit: number = 20) {
 ...
 * Search logs
 */
auditLogSchema.statics.search = async function(searchTerm: string, options: { page?: number; limit?: number } = {}) {
