...
errorLogSchema.statics.getSummary = async function(hours = 24) {
    ...
    return {
        ...
        recentErrors,
        unresolvedCount,
        totalErrors: bySeverity.reduce((sum, item) => sum + item.count, 0)
    };
};

// Static method to get error trends
errorLogSchema.statics.getTrends = async function(days = 7) {
