...
notificationSchema.statics.getUnreadCount = async function(userId: mongoose.Types.ObjectId | string): Promise<number> {
    return await this.countDocuments({ user: userId, isRead: false });
};

// Static method to mark all as read
notificationSchema.statics.markAllAsRead = async function(userId: mongoose.Types.ObjectId | string) {
