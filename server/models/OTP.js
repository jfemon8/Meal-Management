...
otpSchema.methods.verify = async function(otpCode) {
...
otpSchema.statics.verifyByIdentifier = async function(identifier, otpCode, purpose) {
...
otpSchema.statics.checkRateLimit = async function(identifier, purpose, minutes = 15, maxAttempts = 5) {
...
otpSchema.statics.getRecentAttempts = async function(identifier, hours = 24) {
