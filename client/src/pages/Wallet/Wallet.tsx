...
const Wallet: React.FC = () => {
  ...
  const downloadPDFStatement = async () => {
    ...
    try {
      ...
      if (dateRange.balanceType)
        params.append("balanceType", dateRange.balanceType);
      ...
      if (contentType && contentType.includes("application/json")) {
        ...
        throw new Error(errorData.message || "PDF তৈরিতে সমস্যা হয়েছে");
      }
      ...
      if (error.response?.data instanceof Blob) {
        try {
          ...
          const errorData = JSON.parse(text);
          toast.error(errorData.message || "স্টেটমেন্ট ডাউনলোড ব্যর্থ হয়েছে");
        } catch {
          toast.error("স্টেটমেন্ট ডাউনলোড ব্যর্থ হয়েছে");
        }
      } else {
        toast.error(error.message || "স্টেটমেন্ট ডাউনলোড ব্যর্থ হয়েছে");
      }
    } finally {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="card border-l-4 border-blue-500">
          <div className="flex items-start justify-between mb-4">
            ...
            {user?.balances?.breakfast?.amount &&
            user.balances.breakfast.amount >= 0 ? (
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setDateRange({ ...dateRange, balanceType: e.target.value })
              }
              className="input w-full"
            >
          ...
          <div className="flex items-end">
            <button
              ...
              className="btn-primary w-full h-full md:h-3/5 flex items-center justify-center gap-2 rounded-md"
            >
              <FiDownload />
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          ...
          PDF স্টেটমেন্টে আপনার সম্পূর্ণ লেনদেন ইতিহাস এবং বর্তমান ব্যালেন্স
          থাকবে
        </p>
      </div>
