...
const MetricsDashboard: React.FC = () => {
    const { data: dashboard, isLoading, error, refetch, isFetching } = useMetricsDashboard() as {
    ...
    const { data: currentSystem } = useCurrentSystemStats() as { data: SystemStats | undefined };
    const [showErrorLogs, setShowErrorLogs] = useState<boolean>(false);
    const [errorFilter, setErrorFilter] = useState<ErrorFilter>({ severity: '', source: '' });
    const { data: errorLogs, refetch: refetchErrors } = useErrorLogs({
        ...errorFilter,
        limit: 20
    }) as { data: ErrorLogsData | undefined; refetch: () => void };
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="card">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                            (dashboard?.errors?.unresolvedCount || 0) > 0
                ...
                <div className="card">
                    ...
                    {/* Slow Endpoints */}
                    {(dashboard?.apiPerformance?.slowEndpoints?.length || 0) > 0 && (
                        <div>
